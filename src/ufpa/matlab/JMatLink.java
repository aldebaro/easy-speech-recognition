...
/**
 * ToDo list engOpen is supposed to throw an exception if not successfull I'm
 * not sure what happens if large matrices are passed back and force between
 * this class and other applications. Maybe I should always clear all global
 * arrays engGetArray1dD... I'm not sure if the locking mechanism is good or
 * bad. There may be a problem, if two subsequent calls to two different engine
 * routines occur at the same time. what should I do with the return values of
 * the engine functions? Throw an exception? make engPutArray also for int, make
 * engGetArray/Scalar also for int make engGetCharArray also for different
 * engine pointers make something like engGetOutputBuffer
 */
...
public class JMatLink extends Thread {
	...
	// ***************************** engOpen *****************************
	/***************************************************************************
	 * Open engine. This command is used to open a <b>single</b> connection to
	 * matlab.
	 * 
	 * <p>
	 * E.g.:<br>
	 ...
	 * matlab.
	 * <p>
	 * This command is only useful on unix systems. On windows the optional
	 * parameter <b>must</b> be NULL.
	 * 
	 * <p>
	 * E.g.:<br>
	 * 
	...
	// ************************** engOpenSingleUse *****************************
	/***************************************************************************
	 * Open engine for single use. This command is used to open <b>multiple</b>
	 ...
	 * 
	 * <p>Default setting is debug info disabled. <p>E.g.:<br> <pre> JMatLink
	 * engine = new JMatLink(); engine.engOpenSingleUse(); engine.<b>setDebug(true)</b>;
	 * engine.engEvalString("a=ones(10,5);"); engine.engClose(); </pre>
	 **************************************************************************/
	...
	public synchronized void run() {
		...
		while (true) {
			// System.out.println("Number of Java-Threads:
			// "+Thread.activeCount()+"");
			// Thread thread = Thread.currentThread();
			// System.out.println("Name of active Java-Threads:
			// "+thread.getName()+"");
			// System.out.println("active Java-Thread is Daemon:
			// "+thread.isDaemon();+"");
